...
export const state = {
  ...
  ranking: [],
  voteTargetId: null,
  arena: { scores: { red: 0, blue: 0 }, players: [] },
  arenaEvents: [],
  selectedArenaRole: localStorage.getItem("simulac-arena:role") || "striker",
...
export const player = {
  ...
  role: localStorage.getItem("simulac-arena:role") || "striker",
  roleName: "공격",
  team: "red",
  hp: 120,
  maxHp: 120,
